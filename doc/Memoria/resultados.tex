...
\REDNOTE{Do the proyect start in September or February?}

\subsection{Cost planning}
\REDNOTE{Cost of the different elements}
\begin{table}[hp]
	\centering
	{\small
...
\REDNOTE{Development cost taking into account the salary and the estimation of each sprint.}
\begin{table}[hp]
	\centering
	{\small
